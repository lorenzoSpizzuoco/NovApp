    ...
    private static RoomDatabase.Callback sRoomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                postDao.insert(new Post("Hackaton", "mario giordano", R.drawable.security, "ai hackaton!", 1, "13/02/2024", "Milano", 0));
                ...
                postDao.insert(new Post("Gruppo studio", "Lorenzo", R.drawable.analisi, "Gruppo studio analisi 2", 4, "23/01/2024", "Milano", 0));
                postDao.insert(new Post("Conferenza sulla Fisica Quantistica", "Prof. Rossi", R.drawable.ask_customer_feedback , "Discussione sulla teoria quantistica", 2, "24/01/2024", "Aula Magna", 0));
                ...
                postDao.insert(new Post("Avviso Importante - Iscrizioni Esami", "Segreteria Studenti", R.drawable.school, "Scadenza iscrizioni agli esami del prossimo semestre", 1, "21/01/2024", "Online", 0));
